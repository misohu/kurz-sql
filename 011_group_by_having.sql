...
SELECT "AlbumId", SUM("UnitPrice") as final_price
FROM "Track"
GROUP BY "AlbumId"
...
-- Vyfiltruj vidcka albumov, ktorych suma cien skladieb je vacsiaako 8
SELECT "AlbumId", SUM("UnitPrice") as final_price
FROM "Track"
GROUP BY "AlbumId"
...
-- Kolko stoja jednotlive kombinacie albumov a zanrov
SELECT "AlbumId", "GenreId", SUM("UnitPrice") as total
FROM "Track"
