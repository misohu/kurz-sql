...
-- ASC vzostupne 1 ... 10
-- DESC zostupne 10 ... 1
-- Mozme aj na zaklade viac stlpcov
SELECT *
FROM "Track"
ORDER BY 
	"MediaTypeId" DESC, 
...
-- Order by na zaklade noveho stlpca 
SELECT "Milliseconds", ("Milliseconds"/1000)/60::decimal "Minutes"
FROM "Track"
ORDER BY "Minutes" ASC

-- Praca s Null
-- Pomocou Order by viem povedat kde ma ist Null
SELECT *
FROM "Track"
ORDER BY "Composer" DESC NULLS LAST
...
SELECT *
FROM "Track"
WHERE "Bytes" BETWEEN 5000000 AND 7000000

-- na zaklade dlzky slova 
SELECT "Name", LENGTH("Name") AS name_length
FROM "Track"
WHERE LENGTH("Name") > 15 
	AND LENGTH("Name") < 25
-- Vsimnite si ze v tomto pripade musime dat length funkciu priamo do where

-- WHERE s textami 
-- toto je chyba WHERE stlpec == 'string'
SELECT *
FROM "Track"
WHERE "Name" like 'Fa%'
-- toto vsak nie je efektivne ale da sa to pouzit pri malych tabulkach (nazyva sa toi wild carding)
-- % - znamena akakolvek sekvencia znakov roznej dlzky
-- _ - znamena akykolvek jeden znak
SELECT *
FROM "Track"
WHERE "Name" like 'Put The Finger On Yo_'
-- WHERE "Name" like 'Put The Finger On Y_'
-- Wildcarding vieme pouzit aj na zaciatku alebo na konci slova
SELECT *
FROM "Track"
WHERE "Name" like 'The%'
...
-- Existuje aj ILIKE case insensitive like
-- Tento operator neexistuje napriklad v MySql
SELECT *
FROM "Track"
